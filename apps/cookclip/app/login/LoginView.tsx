  ...
  return (
    <div className="min-h-screen bg-[#faf7f2]">
      ...
      <main className="flex flex-col items-center px-4 py-8 pb-16">
        <div className="w-full max-w-[400px] bg-white rounded-2xl border border-[#ddd0bc] shadow-[0_4px_24px_rgba(61,43,31,0.07)] p-8">
          ...
          {signUpDone ? (
            ...
            <div className="text-center py-2">
              ...
              <h2 className="text-[17px] font-extrabold text-[#3d2b1f] mb-2">이메일을 확인해주세요</h2>
            ...
            <>
              ...
              <form onSubmit={handleEmailSubmit} className="flex flex-col gap-3">
                <div>
                  <label className="block text-[12px] font-semibold text-[#7d6550] mb-1.5">이메일</label>
                  <input
                    type="email"
                    value={email}
        ...
        <Link href="/" className="mt-5 text-[13px] text-[#a89880] hover:text-[#7d6550] transition-colors">
          ← 홈으로 돌아가기
        </Link>
      </main>
    </div>
